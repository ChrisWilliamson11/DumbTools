...
class RigUI(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if is_selected({'b_l_thigh_parent', 'b_l_foot_fk', 'b_l_foot_ik', 'b_l_toe_ik', 'b_l_foot_spin_ik', 'b_l_thigh_tweak.001', 'b_l_thigh_ik', 'b_l_thigh_fk', 'b_l_thigh_tweak', 'b_l_calf_tweak.001', 'b_l_toe_fk', 'b_l_calf_fk', 'b_l_foot_tweak', 'b_l_foot_heel_ik', 'VIS_b_l_thigh_ik_pole', 'b_l_calf_tweak', 'b_l_thigh_ik_target'}):
            emit_rig_separator()
            if is_selected({'b_l_thigh_parent', 'b_l_foot_fk', 'b_l_toe_fk', 'b_l_calf_fk', 'b_l_thigh_fk'}):
                layout.prop(pose_bones['b_l_thigh_parent'], '["FK_limb_follow"]', text='FK Limb Follow', slider=True)
            layout.prop(pose_bones['b_l_thigh_parent'], '["IK_FK"]', text='IK-FK (b_l_foot)', slider=True)
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_4de8ao66dec57b86', text='FK->IK (b_l_foot)', icon='SNAP_ON')
            props.output_bones = '["b_l_thigh_fk", "b_l_calf_fk", "b_l_foot_fk", "b_l_toe_fk"]'
            props.input_bones = '["b_l_thigh_ik", "MCH-b_l_calf_ik", "MCH-b_l_thigh_ik_target", "b_l_toe_ik"]'
            props.ctrl_bones = '["b_l_thigh_ik", "b_l_thigh_ik_target", "b_l_foot_ik", "b_l_toe_ik", "b_l_foot_heel_ik", "b_l_foot_spin_ik"]'
            group2 = group1.row(align=True)
            props = group2.operator('pose.rigify_generic_snap_bake_4de8ao66dec57b86', text='Action', icon='ACTION_TWEAK')
            props.output_bones = '["b_l_thigh_fk", "b_l_calf_fk", "b_l_foot_fk", "b_l_toe_fk"]'
            props.input_bones = '["b_l_thigh_ik", "MCH-b_l_calf_ik", "MCH-b_l_thigh_ik_target", "b_l_toe_ik"]'
            props.ctrl_bones = '["b_l_thigh_ik", "b_l_thigh_ik_target", "b_l_foot_ik", "b_l_toe_ik", "b_l_foot_heel_ik", "b_l_foot_spin_ik"]'
            props = group2.operator('pose.rigify_clear_keyframes_4de8ao66dec57b86', text='Clear', icon='CANCEL')
            props.bones = '["b_l_thigh_fk", "b_l_calf_fk", "b_l_foot_fk", "b_l_toe_fk"]'
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_4de8ao66dec57b86', text='IK->FK (b_l_foot)', icon='SNAP_ON')
            props.prop_bone = 'b_l_thigh_parent'
            props.fk_bones = '["b_l_thigh_fk", "b_l_calf_fk", "b_l_foot_fk", "b_l_toe_fk"]'
            props.ik_bones = '["b_l_thigh_ik", "MCH-b_l_calf_ik", "MCH-b_l_thigh_ik_target"]'
            props.ctrl_bones = '["b_l_thigh_ik", "b_l_thigh_ik_target", "b_l_foot_ik"]'
            props.tail_bones = '["b_l_toe_ik"]'
            props.extra_ctrls = '["b_l_foot_heel_ik", "b_l_foot_spin_ik"]'
            group2 = group1.row(align=True)
            props = group2.operator('pose.rigify_limb_ik2fk_bake_4de8ao66dec57b86', text='Action', icon='ACTION_TWEAK')
            props.prop_bone = 'b_l_thigh_parent'
            props.fk_bones = '["b_l_thigh_fk", "b_l_calf_fk", "b_l_foot_fk", "b_l_toe_fk"]'
            props.ik_bones = '["b_l_thigh_ik", "MCH-b_l_calf_ik", "MCH-b_l_thigh_ik_target"]'
            props.ctrl_bones = '["b_l_thigh_ik", "b_l_thigh_ik_target", "b_l_foot_ik"]'
            ...
            props.extra_ctrls = '["b_l_foot_heel_ik", "b_l_foot_spin_ik"]'
            props = group2.operator('pose.rigify_clear_keyframes_4de8ao66dec57b86', text='Clear', icon='CANCEL')
            props.bones = '["b_l_thigh_ik", "b_l_thigh_ik_target", "b_l_foot_ik", "b_l_toe_ik", "b_l_foot_heel_ik", "b_l_foot_spin_ik"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_leg_roll_ik2fk_4de8ao66dec57b86', text='IK->FK With Roll (b_l_foot)', icon='SNAP_ON')
            props.prop_bone = 'b_l_thigh_parent'
            props.fk_bones = '["b_l_thigh_fk", "b_l_calf_fk", "b_l_foot_fk", "b_l_toe_fk"]'
            props.ik_bones = '["b_l_thigh_ik", "MCH-b_l_calf_ik", "MCH-b_l_thigh_ik_target"]'
            props.ctrl_bones = '["b_l_thigh_ik", "b_l_thigh_ik_target", "b_l_foot_ik"]'
            props.tail_bones = '["b_l_toe_ik"]'
            props.extra_ctrls = '["b_l_foot_heel_ik", "b_l_foot_spin_ik"]'
            props.heel_control = 'b_l_foot_heel_ik'
            props = group1.operator('pose.rigify_leg_roll_ik2fk_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
            props.prop_bone = 'b_l_thigh_parent'
            props.fk_bones = '["b_l_thigh_fk", "b_l_calf_fk", "b_l_foot_fk", "b_l_toe_fk"]'
            props.ik_bones = '["b_l_thigh_ik", "MCH-b_l_calf_ik", "MCH-b_l_thigh_ik_target"]'
            props.ctrl_bones = '["b_l_thigh_ik", "b_l_thigh_ik_target", "b_l_foot_ik"]'
            ...
            props.extra_ctrls = '["b_l_foot_heel_ik", "b_l_foot_spin_ik"]'
            props.heel_control = 'b_l_foot_heel_ik'
            if is_selected({'b_l_thigh_parent', 'b_l_toe_ik', 'b_l_foot_ik', 'b_l_thigh_ik', 'b_l_foot_spin_ik', 'b_l_thigh_ik_target', 'b_l_foot_heel_ik'}):
                layout.prop(pose_bones['b_l_thigh_parent'], '["IK_Stretch"]', text='IK Stretch', slider=True)
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_limb_toggle_pole_4de8ao66dec57b86', icon='FORCE_MAGNETIC')
                props.prop_bone = 'b_l_thigh_parent'
                props.ik_bones = '["b_l_thigh_ik", "MCH-b_l_calf_ik", "MCH-b_l_thigh_ik_target"]'
                props.ctrl_bones = '["b_l_thigh_ik", "b_l_thigh_ik_target", "b_l_foot_ik"]'
                props.extra_ctrls = '["b_l_foot_heel_ik", "b_l_foot_spin_ik"]'
                group2.prop(pose_bones['b_l_thigh_parent'], '["pole_vector"]', text=('On' if pose_bones['b_l_thigh_parent']['pole_vector'] else 'Off'), toggle=True)
                props = group1.operator('pose.rigify_limb_toggle_pole_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.prop_bone = 'b_l_thigh_parent'
                props.ik_bones = '["b_l_thigh_ik", "MCH-b_l_calf_ik", "MCH-b_l_thigh_ik_target"]'
                props.ctrl_bones = '["b_l_thigh_ik", "b_l_thigh_ik_target", "b_l_foot_ik"]'
                props.extra_ctrls = '["b_l_foot_heel_ik", "b_l_foot_spin_ik"]'
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_switch_parent_4de8ao66dec57b86', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'b_l_foot_ik'
                props.prop_bone = 'b_l_thigh_parent'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head"]'
                props.locks = (False, False, False)
                group2.prop(pose_bones['b_l_thigh_parent'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.bone = 'b_l_foot_ik'
                props.prop_bone = 'b_l_thigh_parent'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head"]'
                ...
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_switch_parent_4de8ao66dec57b86', text='Pole Parent', icon='DOWNARROW_HLT')
                props.bone = 'b_l_thigh_ik_target'
                props.prop_bone = 'b_l_thigh_parent'
                props.prop_id = 'pole_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "b_l_foot_ik"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['b_l_thigh_parent'], '["pole_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.bone = 'b_l_thigh_ik_target'
                props.prop_bone = 'b_l_thigh_parent'
                props.prop_id = 'pole_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "b_l_foot_ik"]'
                props.locks = (False, True, True)
            if is_selected({'b_l_thigh_tweak.001'}):
                layout.prop(pose_bones['b_l_thigh_tweak.001'], '["rubber_tweak"]', text='Rubber Tweak (b_l_thigh)', slider=True)
            if is_selected({'b_l_calf_tweak'}):
                layout.prop(pose_bones['b_l_calf_tweak'], '["rubber_tweak"]', text='Rubber Tweak (b_l_calf)', slider=True)
            if is_selected({'b_l_calf_tweak.001'}):
                layout.prop(pose_bones['b_l_calf_tweak.001'], '["rubber_tweak"]', text='Rubber Tweak (b_l_calf)', slider=True)

        if is_selected({'b_r_foot_spin_ik', 'b_r_thigh_tweak.001', 'b_r_toe_fk', 'b_r_thigh_fk', 'VIS_b_r_thigh_ik_pole', 'b_r_calf_tweak.001', 'b_r_foot_ik', 'b_r_thigh_tweak', 'b_r_foot_fk', 'b_r_calf_fk', 'b_r_toe_ik', 'b_r_foot_heel_ik', 'b_r_thigh_parent', 'b_r_foot_tweak', 'b_r_calf_tweak', 'b_r_thigh_ik_target', 'b_r_thigh_ik'}):
            emit_rig_separator()
            if is_selected({'b_r_thigh_parent', 'b_r_foot_fk', 'b_r_calf_fk', 'b_r_toe_fk', 'b_r_thigh_fk'}):
                layout.prop(pose_bones['b_r_thigh_parent'], '["FK_limb_follow"]', text='FK Limb Follow', slider=True)
            layout.prop(pose_bones['b_r_thigh_parent'], '["IK_FK"]', text='IK-FK (b_r_foot)', slider=True)
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_4de8ao66dec57b86', text='FK->IK (b_r_foot)', icon='SNAP_ON')
            props.output_bones = '["b_r_thigh_fk", "b_r_calf_fk", "b_r_foot_fk", "b_r_toe_fk"]'
            props.input_bones = '["b_r_thigh_ik", "MCH-b_r_calf_ik", "MCH-b_r_thigh_ik_target", "b_r_toe_ik"]'
            props.ctrl_bones = '["b_r_thigh_ik", "b_r_thigh_ik_target", "b_r_foot_ik", "b_r_toe_ik", "b_r_foot_heel_ik", "b_r_foot_spin_ik"]'
            group2 = group1.row(align=True)
            props = group2.operator('pose.rigify_generic_snap_bake_4de8ao66dec57b86', text='Action', icon='ACTION_TWEAK')
            props.output_bones = '["b_r_thigh_fk", "b_r_calf_fk", "b_r_foot_fk", "b_r_toe_fk"]'
            props.input_bones = '["b_r_thigh_ik", "MCH-b_r_calf_ik", "MCH-b_r_thigh_ik_target", "b_r_toe_ik"]'
            props.ctrl_bones = '["b_r_thigh_ik", "b_r_thigh_ik_target", "b_r_foot_ik", "b_r_toe_ik", "b_r_foot_heel_ik", "b_r_foot_spin_ik"]'
            props = group2.operator('pose.rigify_clear_keyframes_4de8ao66dec57b86', text='Clear', icon='CANCEL')
            props.bones = '["b_r_thigh_fk", "b_r_calf_fk", "b_r_foot_fk", "b_r_toe_fk"]'
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_4de8ao66dec57b86', text='IK->FK (b_r_foot)', icon='SNAP_ON')
            props.prop_bone = 'b_r_thigh_parent'
            props.fk_bones = '["b_r_thigh_fk", "b_r_calf_fk", "b_r_foot_fk", "b_r_toe_fk"]'
            props.ik_bones = '["b_r_thigh_ik", "MCH-b_r_calf_ik", "MCH-b_r_thigh_ik_target"]'
            props.ctrl_bones = '["b_r_thigh_ik", "b_r_thigh_ik_target", "b_r_foot_ik"]'
            props.tail_bones = '["b_r_toe_ik"]'
            props.extra_ctrls = '["b_r_foot_heel_ik", "b_r_foot_spin_ik"]'
            group2 = group1.row(align=True)
            props = group2.operator('pose.rigify_limb_ik2fk_bake_4de8ao66dec57b86', text='Action', icon='ACTION_TWEAK')
            props.prop_bone = 'b_r_thigh_parent'
            props.fk_bones = '["b_r_thigh_fk", "b_r_calf_fk", "b_r_foot_fk", "b_r_toe_fk"]'
            ...
            props.extra_ctrls = '["b_r_foot_heel_ik", "b_r_foot_spin_ik"]'
            props = group2.operator('pose.rigify_clear_keyframes_4de8ao66dec57b86', text='Clear', icon='CANCEL')
            props.bones = '["b_r_thigh_ik", "b_r_thigh_ik_target", "b_r_foot_ik", "b_r_toe_ik", "b_r_foot_heel_ik", "b_r_foot_spin_ik"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_leg_roll_ik2fk_4de8ao66dec57b86', text='IK->FK With Roll (b_r_foot)', icon='SNAP_ON')
            props.prop_bone = 'b_r_thigh_parent'
            props.fk_bones = '["b_r_thigh_fk", "b_r_calf_fk", "b_r_foot_fk", "b_r_toe_fk"]'
            props.ik_bones = '["b_r_thigh_ik", "MCH-b_r_calf_ik", "MCH-b_r_thigh_ik_target"]'
            props.ctrl_bones = '["b_r_thigh_ik", "b_r_thigh_ik_target", "b_r_foot_ik"]'
            props.tail_bones = '["b_r_toe_ik"]'
            props.extra_ctrls = '["b_r_foot_heel_ik", "b_r_foot_spin_ik"]'
            props.heel_control = 'b_r_foot_heel_ik'
            props = group1.operator('pose.rigify_leg_roll_ik2fk_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
            props.prop_bone = 'b_r_thigh_parent'
            props.fk_bones = '["b_r_thigh_fk", "b_r_calf_fk", "b_r_foot_fk", "b_r_toe_fk"]'
            props.ik_bones = '["b_r_thigh_ik", "MCH-b_r_calf_ik", "MCH-b_r_thigh_ik_target"]'
            ...
            props.extra_ctrls = '["b_r_foot_heel_ik", "b_r_foot_spin_ik"]'
            props.heel_control = 'b_r_foot_heel_ik'
            if is_selected({'b_r_foot_spin_ik', 'b_r_foot_ik', 'b_r_thigh_parent', 'b_r_foot_heel_ik', 'b_r_thigh_ik_target', 'b_r_toe_ik', 'b_r_thigh_ik'}):
                layout.prop(pose_bones['b_r_thigh_parent'], '["IK_Stretch"]', text='IK Stretch', slider=True)
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_limb_toggle_pole_4de8ao66dec57b86', icon='FORCE_MAGNETIC')
                props.prop_bone = 'b_r_thigh_parent'
                ...
                props.ctrl_bones = '["b_r_thigh_ik", "b_r_thigh_ik_target", "b_r_foot_ik"]'
                props.extra_ctrls = '["b_r_foot_heel_ik", "b_r_foot_spin_ik"]'
                group2.prop(pose_bones['b_r_thigh_parent'], '["pole_vector"]', text=('On' if pose_bones['b_r_thigh_parent']['pole_vector'] else 'Off'), toggle=True)
                props = group1.operator('pose.rigify_limb_toggle_pole_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.prop_bone = 'b_r_thigh_parent'
                props.ik_bones = '["b_r_thigh_ik", "MCH-b_r_calf_ik", "MCH-b_r_thigh_ik_target"]'
                props.ctrl_bones = '["b_r_thigh_ik", "b_r_thigh_ik_target", "b_r_foot_ik"]'
                ...
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_switch_parent_4de8ao66dec57b86', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'b_r_foot_ik'
                props.prop_bone = 'b_r_thigh_parent'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head"]'
                props.locks = (False, False, False)
                group2.prop(pose_bones['b_r_thigh_parent'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.bone = 'b_r_foot_ik'
                props.prop_bone = 'b_r_thigh_parent'
                props.prop_id = 'IK_parent'
                ...
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_switch_parent_4de8ao66dec57b86', text='Pole Parent', icon='DOWNARROW_HLT')
                props.bone = 'b_r_thigh_ik_target'
                props.prop_bone = 'b_r_thigh_parent'
                props.prop_id = 'pole_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "b_r_foot_ik"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['b_r_thigh_parent'], '["pole_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.bone = 'b_r_thigh_ik_target'
                props.prop_bone = 'b_r_thigh_parent'
                props.prop_id = 'pole_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "b_r_foot_ik"]'
                props.locks = (False, True, True)
            if is_selected({'b_r_thigh_tweak.001'}):
                layout.prop(pose_bones['b_r_thigh_tweak.001'], '["rubber_tweak"]', text='Rubber Tweak (b_r_thigh)', slider=True)
            if is_selected({'b_r_calf_tweak'}):
                layout.prop(pose_bones['b_r_calf_tweak'], '["rubber_tweak"]', text='Rubber Tweak (b_r_calf)', slider=True)
            if is_selected({'b_r_calf_tweak.001'}):
                layout.prop(pose_bones['b_r_calf_tweak.001'], '["rubber_tweak"]', text='Rubber Tweak (b_r_calf)', slider=True)

        if is_selected({'b_l_upperarm_tweak', 'b_l_hand_fk', 'VIS_b_l_upperarm_ik_pole', 'b_l_upperarm_fk', 'b_l_upperarm_parent', 'b_l_forearm_tweak', 'b_l_hand_ik', 'b_l_forearm_fk', 'b_l_forearm_tweak.001', 'b_l_hand_tweak', 'b_l_upperarm_tweak.001', 'b_l_upperarm_ik', 'b_l_upperarm_ik_target'}):
            emit_rig_separator()
            if is_selected({'b_l_upperarm_fk', 'b_l_forearm_fk', 'b_l_upperarm_parent', 'b_l_hand_fk'}):
                layout.prop(pose_bones['b_l_upperarm_parent'], '["FK_limb_follow"]', text='FK Limb Follow', slider=True)
            layout.prop(pose_bones['b_l_upperarm_parent'], '["IK_FK"]', text='IK-FK (b_l_hand)', slider=True)
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_4de8ao66dec57b86', text='FK->IK (b_l_hand)', icon='SNAP_ON')
            props.output_bones = '["b_l_upperarm_fk", "b_l_forearm_fk", "b_l_hand_fk"]'
            props.input_bones = '["b_l_upperarm_ik", "MCH-b_l_forearm_ik", "MCH-b_l_upperarm_ik_target"]'
            props.ctrl_bones = '["b_l_upperarm_ik", "b_l_upperarm_ik_target", "b_l_hand_ik"]'
            group2 = group1.row(align=True)
            props = group2.operator('pose.rigify_generic_snap_bake_4de8ao66dec57b86', text='Action', icon='ACTION_TWEAK')
            props.output_bones = '["b_l_upperarm_fk", "b_l_forearm_fk", "b_l_hand_fk"]'
            props.input_bones = '["b_l_upperarm_ik", "MCH-b_l_forearm_ik", "MCH-b_l_upperarm_ik_target"]'
            props.ctrl_bones = '["b_l_upperarm_ik", "b_l_upperarm_ik_target", "b_l_hand_ik"]'
            props = group2.operator('pose.rigify_clear_keyframes_4de8ao66dec57b86', text='Clear', icon='CANCEL')
            props.bones = '["b_l_upperarm_fk", "b_l_forearm_fk", "b_l_hand_fk"]'
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_4de8ao66dec57b86', text='IK->FK (b_l_hand)', icon='SNAP_ON')
            props.prop_bone = 'b_l_upperarm_parent'
            props.fk_bones = '["b_l_upperarm_fk", "b_l_forearm_fk", "b_l_hand_fk"]'
            props.ik_bones = '["b_l_upperarm_ik", "MCH-b_l_forearm_ik", "MCH-b_l_upperarm_ik_target"]'
            props.ctrl_bones = '["b_l_upperarm_ik", "b_l_upperarm_ik_target", "b_l_hand_ik"]'
            props.tail_bones = '[]'
            props.extra_ctrls = '[]'
            group2 = group1.row(align=True)
            ...
            props.extra_ctrls = '[]'
            props = group2.operator('pose.rigify_clear_keyframes_4de8ao66dec57b86', text='Clear', icon='CANCEL')
            props.bones = '["b_l_upperarm_ik", "b_l_upperarm_ik_target", "b_l_hand_ik"]'
            if is_selected({'b_l_upperarm_ik', 'b_l_hand_ik', 'b_l_upperarm_parent', 'b_l_upperarm_ik_target'}):
                layout.prop(pose_bones['b_l_upperarm_parent'], '["IK_Stretch"]', text='IK Stretch', slider=True)
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_limb_toggle_pole_4de8ao66dec57b86', icon='FORCE_MAGNETIC')
                props.prop_bone = 'b_l_upperarm_parent'
                ...
                props.ctrl_bones = '["b_l_upperarm_ik", "b_l_upperarm_ik_target", "b_l_hand_ik"]'
                props.extra_ctrls = '[]'
                group2.prop(pose_bones['b_l_upperarm_parent'], '["pole_vector"]', text=('On' if pose_bones['b_l_upperarm_parent']['pole_vector'] else 'Off'), toggle=True)
                props = group1.operator('pose.rigify_limb_toggle_pole_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.prop_bone = 'b_l_upperarm_parent'
                props.ik_bones = '["b_l_upperarm_ik", "MCH-b_l_forearm_ik", "MCH-b_l_upperarm_ik_target"]'
                props.ctrl_bones = '["b_l_upperarm_ik", "b_l_upperarm_ik_target", "b_l_hand_ik"]'
                ...
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_switch_parent_4de8ao66dec57b86', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'b_l_hand_ik'
                props.prop_bone = 'b_l_upperarm_parent'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "b_l_clav"]'
                props.locks = (False, False, False)
                group2.prop(pose_bones['b_l_upperarm_parent'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.bone = 'b_l_hand_ik'
                props.prop_bone = 'b_l_upperarm_parent'
                props.prop_id = 'IK_parent'
                ...
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_switch_parent_4de8ao66dec57b86', text='Pole Parent', icon='DOWNARROW_HLT')
                props.bone = 'b_l_upperarm_ik_target'
                props.prop_bone = 'b_l_upperarm_parent'
                props.prop_id = 'pole_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "b_l_clav", "b_l_hand_ik"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['b_l_upperarm_parent'], '["pole_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.bone = 'b_l_upperarm_ik_target'
                props.prop_bone = 'b_l_upperarm_parent'
                props.prop_id = 'pole_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "b_l_clav", "b_l_hand_ik"]'
                props.locks = (False, True, True)
            if is_selected({'b_l_upperarm_tweak.001'}):
                layout.prop(pose_bones['b_l_upperarm_tweak.001'], '["rubber_tweak"]', text='Rubber Tweak (b_l_upperarm)', slider=True)
            if is_selected({'b_l_forearm_tweak'}):
                layout.prop(pose_bones['b_l_forearm_tweak'], '["rubber_tweak"]', text='Rubber Tweak (b_l_forearm)', slider=True)
            if is_selected({'b_l_forearm_tweak.001'}):
                layout.prop(pose_bones['b_l_forearm_tweak.001'], '["rubber_tweak"]', text='Rubber Tweak (b_l_forearm)', slider=True)

        if is_selected({'b_l_index_1', 'b_l_index_3', 'b_l_index_1_master', 'b_l_index_2', 'b_l_index_1.001'}):
            emit_rig_separator()
            layout.prop(pose_bones['b_l_index_1_master'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'b_l_middle_2', 'b_l_middle_1.001', 'b_l_middle_3', 'b_l_middle_1', 'b_l_middle_1_master'}):
            emit_rig_separator()
            layout.prop(pose_bones['b_l_middle_1_master'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'b_l_pinky_1.001', 'b_l_pinky_2', 'b_l_pinky_3', 'b_l_pinky_1_master', 'b_l_pinky_1'}):
            emit_rig_separator()
            layout.prop(pose_bones['b_l_pinky_1_master'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'b_l_ring_2', 'b_l_ring_1_master', 'b_l_ring_1', 'b_l_ring_3', 'b_l_ring_1.001'}):
            emit_rig_separator()
            layout.prop(pose_bones['b_l_ring_1_master'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'b_l_thumb_2', 'b_l_thumb_1.001', 'b_l_thumb_3', 'b_l_thumb_1_master', 'b_l_thumb_1'}):
            emit_rig_separator()
            layout.prop(pose_bones['b_l_thumb_1_master'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'tweak_b_neck_1', 'b_spine_1_fk', 'tweak_b_pelvis', 'head', 'tweak_b_spine_3', 'neck', 'hips', 'tweak_b_spine_1', 'tweak_b_spine_2', 'b_spine_2_fk', 'b_spine_3_fk', 'chest', 'b_pelvis_fk', 'torso'}):
            emit_rig_separator()
            ...
            if is_selected({'tweak_b_neck_1', 'b_spine_1_fk', 'tweak_b_pelvis', 'tweak_b_spine_3', 'hips', 'tweak_b_spine_1', 'tweak_b_spine_2', 'b_spine_2_fk', 'b_spine_3_fk', 'chest', 'b_pelvis_fk', 'torso'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_switch_parent_4de8ao66dec57b86', text='Torso Parent', icon='DOWNARROW_HLT')
                props.bone = 'torso'
        ...
        if is_selected({'b_r_upperarm_parent', 'VIS_b_r_upperarm_ik_pole', 'b_r_hand_fk', 'b_r_upperarm_ik', 'b_r_upperarm_fk', 'b_r_upperarm_tweak.001', 'b_r_hand_tweak', 'b_r_hand_ik', 'b_r_upperarm_tweak', 'b_r_forearm_tweak.001', 'b_r_forearm_fk', 'b_r_upperarm_ik_target', 'b_r_forearm_tweak'}):
            emit_rig_separator()
            if is_selected({'b_r_upperarm_parent', 'b_r_upperarm_fk', 'b_r_hand_fk', 'b_r_forearm_fk'}):
                layout.prop(pose_bones['b_r_upperarm_parent'], '["FK_limb_follow"]', text='FK Limb Follow', slider=True)
            layout.prop(pose_bones['b_r_upperarm_parent'], '["IK_FK"]', text='IK-FK (b_r_hand)', slider=True)
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_4de8ao66dec57b86', text='FK->IK (b_r_hand)', icon='SNAP_ON')
            props.output_bones = '["b_r_upperarm_fk", "b_r_forearm_fk", "b_r_hand_fk"]'
            props.input_bones = '["b_r_upperarm_ik", "MCH-b_r_forearm_ik", "MCH-b_r_upperarm_ik_target"]'
            props.ctrl_bones = '["b_r_upperarm_ik", "b_r_upperarm_ik_target", "b_r_hand_ik"]'
            group2 = group1.row(align=True)
            props = group2.operator('pose.rigify_generic_snap_bake_4de8ao66dec57b86', text='Action', icon='ACTION_TWEAK')
            props.output_bones = '["b_r_upperarm_fk", "b_r_forearm_fk", "b_r_hand_fk"]'
            props.input_bones = '["b_r_upperarm_ik", "MCH-b_r_forearm_ik", "MCH-b_r_upperarm_ik_target"]'
            props.ctrl_bones = '["b_r_upperarm_ik", "b_r_upperarm_ik_target", "b_r_hand_ik"]'
            props = group2.operator('pose.rigify_clear_keyframes_4de8ao66dec57b86', text='Clear', icon='CANCEL')
            props.bones = '["b_r_upperarm_fk", "b_r_forearm_fk", "b_r_hand_fk"]'
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_4de8ao66dec57b86', text='IK->FK (b_r_hand)', icon='SNAP_ON')
            props.prop_bone = 'b_r_upperarm_parent'
            props.fk_bones = '["b_r_upperarm_fk", "b_r_forearm_fk", "b_r_hand_fk"]'
            props.ik_bones = '["b_r_upperarm_ik", "MCH-b_r_forearm_ik", "MCH-b_r_upperarm_ik_target"]'
            props.ctrl_bones = '["b_r_upperarm_ik", "b_r_upperarm_ik_target", "b_r_hand_ik"]'
            props.tail_bones = '[]'
            props.extra_ctrls = '[]'
            group2 = group1.row(align=True)
            ...
            props.extra_ctrls = '[]'
            props = group2.operator('pose.rigify_clear_keyframes_4de8ao66dec57b86', text='Clear', icon='CANCEL')
            props.bones = '["b_r_upperarm_ik", "b_r_upperarm_ik_target", "b_r_hand_ik"]'
            if is_selected({'b_r_upperarm_parent', 'b_r_hand_ik', 'b_r_upperarm_ik', 'b_r_upperarm_ik_target'}):
                layout.prop(pose_bones['b_r_upperarm_parent'], '["IK_Stretch"]', text='IK Stretch', slider=True)
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_limb_toggle_pole_4de8ao66dec57b86', icon='FORCE_MAGNETIC')
                props.prop_bone = 'b_r_upperarm_parent'
                ...
                props.ctrl_bones = '["b_r_upperarm_ik", "b_r_upperarm_ik_target", "b_r_hand_ik"]'
                props.extra_ctrls = '[]'
                group2.prop(pose_bones['b_r_upperarm_parent'], '["pole_vector"]', text=('On' if pose_bones['b_r_upperarm_parent']['pole_vector'] else 'Off'), toggle=True)
                props = group1.operator('pose.rigify_limb_toggle_pole_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.prop_bone = 'b_r_upperarm_parent'
                props.ik_bones = '["b_r_upperarm_ik", "MCH-b_r_forearm_ik", "MCH-b_r_upperarm_ik_target"]'
                props.ctrl_bones = '["b_r_upperarm_ik", "b_r_upperarm_ik_target", "b_r_hand_ik"]'
                ...
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_switch_parent_4de8ao66dec57b86', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'b_r_hand_ik'
                props.prop_bone = 'b_r_upperarm_parent'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "b_r_clav"]'
                props.locks = (False, False, False)
                group2.prop(pose_bones['b_r_upperarm_parent'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.bone = 'b_r_hand_ik'
                props.prop_bone = 'b_r_upperarm_parent'
                props.prop_id = 'IK_parent'
                ...
                group2 = group1.split(factor=0.65, align=True)
                props = group2.operator('pose.rigify_switch_parent_4de8ao66dec57b86', text='Pole Parent', icon='DOWNARROW_HLT')
                props.bone = 'b_r_upperarm_ik_target'
                props.prop_bone = 'b_r_upperarm_parent'
                props.prop_id = 'pole_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "b_r_clav", "b_r_hand_ik"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['b_r_upperarm_parent'], '["pole_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_4de8ao66dec57b86', text='', icon='ACTION_TWEAK')
                props.bone = 'b_r_upperarm_ik_target'
                props.prop_bone = 'b_r_upperarm_parent'
                props.prop_id = 'pole_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "b_r_clav", "b_r_hand_ik"]'
                props.locks = (False, True, True)
            if is_selected({'b_r_upperarm_tweak.001'}):
                layout.prop(pose_bones['b_r_upperarm_tweak.001'], '["rubber_tweak"]', text='Rubber Tweak (b_r_upperarm)', slider=True)
            if is_selected({'b_r_forearm_tweak'}):
                layout.prop(pose_bones['b_r_forearm_tweak'], '["rubber_tweak"]', text='Rubber Tweak (b_r_forearm)', slider=True)
            if is_selected({'b_r_forearm_tweak.001'}):
                layout.prop(pose_bones['b_r_forearm_tweak.001'], '["rubber_tweak"]', text='Rubber Tweak (b_r_forearm)', slider=True)

        if is_selected({'b_r_index_1.001', 'b_r_index_1', 'b_r_index_3', 'b_r_index_2', 'b_r_index_1_master'}):
            emit_rig_separator()
            layout.prop(pose_bones['b_r_index_1_master'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'b_r_middle_1_master', 'b_r_middle_2', 'b_r_middle_3', 'b_r_middle_1', 'b_r_middle_1.001'}):
            emit_rig_separator()
            layout.prop(pose_bones['b_r_middle_1_master'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'b_r_pinky_3', 'b_r_pinky_1_master', 'b_r_pinky_1.001', 'b_r_pinky_2', 'b_r_pinky_1'}):
            emit_rig_separator()
            layout.prop(pose_bones['b_r_pinky_1_master'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'b_r_ring_1.001', 'b_r_ring_1', 'b_r_ring_3', 'b_r_ring_2', 'b_r_ring_1_master'}):
            emit_rig_separator()
            layout.prop(pose_bones['b_r_ring_1_master'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'b_r_thumb_1.001', 'b_r_thumb_1', 'b_r_thumb_1_master', 'b_r_thumb_3', 'b_r_thumb_2'}):
            emit_rig_separator()
            layout.prop(pose_bones['b_r_thumb_1_master'], '["finger_curve"]', text='Curvature', slider=True)
